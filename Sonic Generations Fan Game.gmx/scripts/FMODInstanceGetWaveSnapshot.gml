...
//returns "" on error
//returns the wave data string on success
...
//buffer = FMODInstanceGetWaveSnapshot(instance,0, 256)
...
external_call(global.dll_FMODInstanceGetWaveSnapshot,argument0,argument1,argument2,buf);
return buf;