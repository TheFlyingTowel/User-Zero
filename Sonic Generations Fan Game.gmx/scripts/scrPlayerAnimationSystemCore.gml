    ...
    */
    ...
    if ( Animation != AnimationPrevious )
    {
        ...
        AnimationStart       = variable_local_get("Animation"+Animation+"Start");
        AnimationEnd         = variable_local_get("Animation"+Animation+"End");
        AnimationLoop        = variable_local_get("Animation"+Animation+"Loop");
        AnimationSpeed       = variable_local_get("Animation"+Animation+"Speed");
        AnimationRepeat      = variable_local_get("Animation"+Animation+"Repeat");
        AnimationRepeatTimes = variable_local_get("Animation"+Animation+"RepeatTimes");
        AnimationLinkedTo    = variable_local_get("Animation"+Animation+"LinkedTo");
